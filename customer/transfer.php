          ...
          <div class="sm:rounded-lg">
            <div class="px-4 py-5 sm:p-6">
              <div class="mt-4 text-sm text-gray-500">
                ...
                use  src\Classes\Customer\Transfer;

                $object = new Transfer();

                if (isset($_POST['transferAmount'])) {
                  $object->input_transfer($_POST);
                }

                ?>
                <form action="#" method="POST">
                  <!-- Recipient's Email Input -->
                  <input type="email" name="transferEmail" id="email" class="block w-full ring-0 outline-none py-2 text-gray-800 border-b placeholder:text-gray-400 md:text-4xl" placeholder="Recipient's Email Address" required />
                  ...
                  <div class="relative mt-4 md:mt-8">
                    ...
                    <input type="number" name="transferAmount" id="amount" class="block w-full ring-0 outline-none pl-4 py-2 md:pl-8 text-gray-800 border-b border-b-emerald-500 placeholder:text-gray-400 md:text-4xl" placeholder="0.00" required />
                  </div>
