          ...
          <div class="sm:rounded-lg">
            <div class="px-4 py-5 sm:p-6">
              ...
              <div class="mt-4 text-sm text-gray-500">
                ...
                use  src\Classes\Customer\Deposit;

                $object = new Deposit();

                if (isset($_POST['deposit'])) {
                  $object->input_deposit($_POST);
                }
                ...
                <form action="#" method="POST">
                  ...
                  <!-- Submit Button -->
                  <div class="mt-5">
                    <button type="submit" name="deposit" class="w-full px-6 py-3.5 text-base font-medium text-white bg-emerald-600 hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-300 rounded-lg sm:text-xl text-center">
                      Proceed
                    </button>
                  </div>
                </form>
