...
if ($_SESSION['role'] == 'admin') { ?>
                  <a href="../admin/customers.php" class="text-white hover:bg-emerald-500 hover:bg-opacity-75 rounded-md py-2 px-3 text-sm font-medium">Customer</a>
                  <a href="../admin/transactions.php" class="text-white hover:bg-emerald-500 hover:bg-opacity-75 rounded-md py-2 px-3 text-sm font-medium">Transections</a>
<?php } ?>
      ...
      <header class="py-10">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h1 class="text-3xl font-bold tracking-tight text-white">
            <?php echo $_SESSION['email']; ?>Howdy, Shamim Ahmed 👋
          </h1>
        </div>
      </header>
    </div>
