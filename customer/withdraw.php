          ...
          <div class="sm:rounded-lg">
            <div class="px-4 py-5 sm:p-6">
              ...
              <div class="mt-4 text-sm text-gray-500">
                ...
                use  src\Classes\Customer\Withdraw;

                $object = new Withdraw();

                if (isset($_POST['withdraw'])) {
                  $object->input_withdraw($_POST);
                }
                ...
                <form action="" method="POST">
                  ...
                  <div class="relative mt-2 rounded-md">
                    ...
                    <input type="number" name="withdrawAmount" id="amount" class="block w-full ring-0 outline-none text-xl pl-4 py-2 sm:pl-8 text-gray-800 border-b border-b-emerald-500 placeholder:text-gray-400 sm:text-4xl" placeholder="0.00" required />
                  </div>

                  <!-- Submit Button -->
                  <div class="mt-5">
                    <button type="submit" name="withdraw" class="w-full px-6 py-3.5 text-base font-medium text-white bg-emerald-600 hover:bg-emerald-800 focus:ring-4 focus:outline-none focus:ring-emerald-300 rounded-lg sm:text-xl text-center">
                      Proceed
                    </button>
                  </div>
                </form>
